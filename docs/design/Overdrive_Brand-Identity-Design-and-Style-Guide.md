...
**Usage:** For use by internal marketing teams, designers, AI tools, and external vendors who create visuals, decks, web interfaces, illustrations, or collateral. Consistency builds trust. Distinctiveness builds recognition.
